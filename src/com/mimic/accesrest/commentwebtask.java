...
public class commentwebtask extends AsyncTask<Integer, Integer, String>{
		...
		protected void onPostExecute(String result){
			...
			try{
				...
				playdata.add(new MimicData(username, dpurl, url, postid, likes, commentsx, posturl, description, likesbool, timestamp, null, true));
				JSONArray comments = respobj.getJSONArray("comments");
					for (int i=0; i<comments.length(); i++){
						...
						commentdata.add(new commentdata(commenturl, commentuser, profilepictureurl, time));
